...
export default function Login() {
 ...
 async function handleLogin(e) {
  ...
  try {
    ...
    // OTP temporarily disabled during development
    // Will re-enable before final demo
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '36px' }}>
          <div style={{
            ...
            <span style={{
              ...
              fontSize: '28px', color: '#fff', letterSpacing: '3px',
            }}>
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <button
            ...
            style={{
              ...
              background: loading
                ? 'rgba(74,222,128,0.3)'
                : 'linear-gradient(135deg, rgba(74,222,128,0.9), rgba(34,197,94,0.8))',
        ...
        <div style={{
          ...
          <span style={{ fontSize: '10px', color: 'rgba(255,255,255,0.2)', letterSpacing: '1px' }}>
            2FA OTP verification required after login
          </span>
        </div>
      </div>
