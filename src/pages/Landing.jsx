...
export default function Landing() {
  ...
  const roles = [
    {
      ...
      accent: "#4ade80",
      rgb: "74,222,128",
      tag: "Register harvests",
      desc: "Log your crop, GPS, and chemicals permanently on-chain.",
    },
    {
      role: "buyer",
      label: "Buyer",
      ...
      rgb: "96,165,250",
      tag: "Verify produce",
      desc: "Scan a QR and instantly confirm what you are buying.",
    },
  ];
  ...
  return (
    <>
      ...
      <div
        style={{ fontFamily: "'Inter', sans-serif", background: "#060c04" }}
      ...
      >
        ...
        <div className="relative min-h-screen overflow-hidden flex flex-col">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, rgba(4,9,2,0.72) 0%, rgba(4,9,2,0.45) 40%, rgba(4,9,2,0.90) 100%)",
            }}
          />
          <div
            className="absolute inset-0"
            style={{
              background:
                "radial-gradient(ellipse 70% 80% at 50% 50%, rgba(4,9,2,0.35) 0%, rgba(4,9,2,0.78) 100%)",
            }}
          />
          ...
          <nav className="relative z-10 flex items-center justify-between px-6 md:px-12 pt-6 md:pt-8">
            <div className="flex flex-col leading-none">
              ...
              <span className="text-[8px] text-white/30 tracking-[2px] uppercase mt-0.5">
                Blockchain Verified
              </span>
            </div>
            ...
            <ul className="hidden md:flex gap-8 list-none m-0 p-0">
              {["Home", "About", "How it works", "Verify"].map((item, i) => (
                <li key={item}>
                  <a
                    href="#"
                    className={`text-[11px] tracking-[1.5px] uppercase no-underline transition-colors ${i === 0 ? "text-green-400" : "text-white/40 hover:text-white"}`}
                  >
                    {item}
                  </a>
                </li>
          ...
          <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-6 md:px-12 pt-10 pb-6">
            ...
            <p className="text-white/50 text-[13px] md:text-[14px] leading-relaxed max-w-md mt-5 tracking-wide">
              Blockchain-powered agricultural traceability. Every harvest
              registered, verified, and fraud-proof from farm to buyer.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-8 md:gap-12 mt-10 pt-8 w-full max-w-xl border-t border-white/[0.06]">
              {stats.map(({ label, value, tag }) => (
                <div key={label} className="text-center">
                  <div className="text-[9px] tracking-[1.5px] uppercase text-white/25 mb-1">
                    {label}
                  </div>
                  <div
                    style={{
                  ...
                  >
                    {value}
                    <span
                      className="text-green-400 text-[11px] ml-1.5"
          ...
          <div className="absolute bottom-6 right-5 md:right-10 z-10 bg-black/55 border border-green-400/20 rounded-lg px-3 py-2.5 md:px-4 md:py-3">
            ...
            <div className="font-mono text-[9px] md:text-[10px] text-green-400/75">
              0x4f3a...d92c · Block #18,442,201
            </div>
          </div>
        </div>
        ...
        <div
          style={{
            ...
            height: "120px",
            marginBottom: "-2px",
            background: "linear-gradient(to bottom, #060c04, transparent)",
            zIndex: 2,
            pointerEvents: "none",
          }}
        />
        ...
        >
          ...
          <div
            style={{
              ...
              height: "220px",
              background:
                "linear-gradient(to bottom, #060c04 0%, rgba(4,9,2,0.0) 100%)",
              zIndex: 1,
            }}
          />
          ...
          <div
            style={{
              ...
              height: "520px",
              background:
                "linear-gradient(to top, rgba(4,9,2,0.96) 0%, rgba(4,9,2,0.5) 50%, rgba(4,9,2,0.0) 100%)",
              zIndex: 1,
            }}
          />
          ...
          <div
            style={{
              ...
              height: "1px",
              background:
                "linear-gradient(to right, transparent, rgba(74,222,128,0.35), transparent)",
              zIndex: 2,
            }}
          />
          ...
          >
            ...
            <div style={{ textAlign: "center", marginBottom: "72px" }}>
              ...
              >
                Four steps that take your harvest from the field to a verified,
                fraud-proof record on the blockchain.
              </p>
            </div>
                  ...
                  {i < steps.length - 1 && (
                    <div
                      style={{
                        ...
                        height: "1px",
                        background:
                          "linear-gradient(to right, rgba(74,222,128,0.3), rgba(74,222,128,0.06))",
                      }}
                    />
                  )}
                </div>
          ...
          >
            ...
            <div
              style={{
                ...
                height: "1px",
                background:
                  "linear-gradient(to right, transparent, rgba(74,222,128,0.4), transparent)",
              }}
            />
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    Securing Africa's agricultural supply chain, one block at a
                    time.
                  </p>
                </div>
                ...
                <div>
                  ...
                  >
                    {["Home", "How it works", "Verify produce", "About"].map(
                      (link) => (
                        <a
                          key={link}
                          href="#"
